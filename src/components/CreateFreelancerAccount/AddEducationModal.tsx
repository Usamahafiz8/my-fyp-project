...
import { type EducationForm } from "@/utils/types/freelancer-profile";
...
function AddEducationModal({
  ...
  function submitForm(e: EducationForm) {
    handleModalData(e);
    reset();
  }
  return (
              ...
              <div className="grid gap-4 mb-4 sm:grid-cols-2">
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    placeholder="Ex. COMSATS University Islamabad, Attock Campus."
                    required
                  />
                </div>
                <div>
