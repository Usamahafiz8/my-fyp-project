...
export default function DashboardSkelton({}: Props) {
  const [isNotiOpen, setNotiOpen] = useState(false);
  const [isAppOpen, setAppOpen] = useState(false);
  const [isProfileOpen, setProfileOpen] = useState(false);

  function closeAllHeaderTabs() {
    setNotiOpen(false);
    setProfileOpen(false);
    setAppOpen(false);
  }
  function handleTabOpener(action?: string) {
    if (action == "TabNotifications") {
      setNotiOpen(!isNotiOpen);
      setAppOpen(false);
      setProfileOpen(false);
    } else if (action == "TabApps") {
      setNotiOpen(false);
      setAppOpen(!isAppOpen);
      setProfileOpen(false);
    } else if (action == "TabProfile") {
      setNotiOpen(false);
      setAppOpen(false);
  ...
  return (
    <div className="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <button
              ...
              onClick={() => handleTabOpener("TabNotifications")}
            >
            ...
            <NotificationsDropDown open={isNotiOpen} />
            ...
            <button
              ...
              onClick={() => handleTabOpener("TabApps")}
            >
              <span className="sr-only">View notifications</span>
              {/* <!-- Icon --> */}
              <svg
            ...
            {/* <!-- Dropdown menu --> */}
            <ProfileDropDown open={isProfileOpen} />
          </div>
        </div>
      </nav>
      ...
      {/* Dashboard Body */}
      <main className="p-4 md:ml-64 h-auto pt-20 dark:bg-slate-800">
