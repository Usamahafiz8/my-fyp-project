          ...
          <nav className="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
            <div className="relative" x-data="{ open: true }">
              ...
              <div
                //@ts-ignore
                xShow="close"
                // xTransition:enter="transition ease-out duration-100"
                // x-Transition:enterStart="transform opacity-0 scale-95"
                // xTransition:enter-end="transform opacity-100 scale-100"
                // xTransition:leave="transition ease-in duration-75"
                // xTransition:leave-start="transform opacity-100 scale-100"
                // xTransition:leave-end="transform opacity-0 scale-95"
              ...
              <ul className="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                <li className="flex items-center py-3">
                  ...
                  <span className="ml-auto">
                    <span className="bg-purple-500 py-1 px-2 rounded text-white text-sm">
                      InActive
                    </span>
                  </span>
                </li>
              ...
              <div className="text-gray-700">
                <div className="grid md:grid-cols-2 text-sm">
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">Awais</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Last Name</div>
                    <div className="px-4 py-2">Yusaf</div>
                  </div>
                  <div className="grid grid-cols-2">
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">0306 5396548</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">
                      Current Address
                    </div>
                    <div className="px-4 py-2">Attock City</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">
                      Permanant Address
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">Sep 09, 1999</div>
                  </div>
                </div>
              </div>
